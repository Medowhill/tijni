...
JNIEXPORT
jlong JNICALL Java_Point_nativeGetX(JNIEnv *env, jobject thiz, jlong ptr) {
  return point_get_x((point *) ptr);
}


JNIEXPORT
jlong JNICALL Java_Point_nativeGetY(JNIEnv *env, jobject thiz, jlong ptr) {
  return point_get_y((point *) ptr);
}

JNIEXPORT
void JNICALL Java_Point_nativeSetX(JNIEnv *env, jobject thiz, jlong ptr, jlong x) {
  point_set_x((point *) ptr, x);
}

JNIEXPORT
void JNICALL Java_Point_nativeSetY(JNIEnv *env, jobject thiz, jlong ptr, jlong y) {
  point_set_y((point *) ptr, y);
}

JNIEXPORT
jlong JNICALL Java_Point_nativeDist(JNIEnv *env, jobject thiz, jlong ptr1, jlong ptr2) {
